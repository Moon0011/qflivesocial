...
import static com.qingfeng.livesocial.common.Constants.PARAM_SIGNATURE;
import static com.qingfeng.livesocial.common.Constants.PARAM_SIGNATURE_INFO_EDIT_TYPE_VALUE;
...
public class QianmingActivity extends BaseActivity {
    ...
    protected int getLayoutById() {
        return R.layout.qingming_layout;
    }
    ...
    private void updateQianMing() {
        ...
        params.addParameter(PARAM_TYPE, PARAM_SIGNATURE_INFO_EDIT_TYPE_VALUE);
        params.addParameter(PARAM_SIGNATURE, etQianming.getText().toString().trim());
        x.http().post(params, new Callback.CommonCallback<String>() {
            @Override
            public void onSuccess(String result) {
                LogUtil.e("updateQianMing == " + result);
