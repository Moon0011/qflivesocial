...
public class Urls {
    ...
    public static final String ATTENTION = String.format("http://%s/index.php/api/user/attention", DOMAIN_NAME);
    ...
    public static final String ATTPAGE = String.format("http://%s/index.php/api/user/attpage", DOMAIN_NAME);//关注页
