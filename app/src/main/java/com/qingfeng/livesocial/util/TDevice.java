package com.qingfeng.livesocial.util;
...
public class TDevice {
    ...
    public static int getDefaultLoadFactor() {
        if (_loadFactor == null) {
            Integer integer = Integer.valueOf(0xf & QFApplication.context()
    ...
    public static DisplayMetrics getDisplayMetrics() {
        ...
        ((WindowManager) QFApplication.context().getSystemService(
    ...
    public static int getStatusBarHeight() {
        ...
        try {
            ...
            return QFApplication.context().getResources()
    ...
    public static boolean hasBigScreen() {
        ...
        if (_hasBigScreen == null) {
            boolean flag1;
            if ((0xf & QFApplication.context().getResources()
    ...
    public static final boolean hasCamera() {
        if (_hasCamera == null) {
            PackageManager pckMgr = QFApplication.context()
                    .getPackageManager();
            boolean flag = pckMgr
    ...
    public static boolean hasInternet() {
        boolean flag;
        if (((ConnectivityManager) QFApplication.context().getSystemService(
    ...
    public static boolean isPackageExist(String pckName) {
        try {
            PackageInfo pckInfo = QFApplication.context().getPackageManager()
    ...
    public static boolean isLandscape() {
        boolean flag;
        if (QFApplication.context().getResources().getConfiguration().orientation == 2)
            flag = true;
        else
            flag = false;
        return flag;
    ...
    public static boolean isPortrait() {
        boolean flag = true;
        if (QFApplication.context().getResources().getConfiguration().orientation != 1)
            flag = false;
        return flag;
    }
    ...
    public static void showSoftKeyboard(View view) {
        if (view == null)
            return;
        /*
        ((InputMethodManager) QFApplication.context().getSystemService(
    ...
    public static String getCurCountryLan() {
        return QFApplication.context().getResources().getConfiguration().locale
                .getLanguage()
                + "-"
                + QFApplication.context().getResources().getConfiguration().locale
                .getCountry();
    }

    public static boolean isZhCN() {
        String lang = QFApplication.context().getResources()
    ...
    public static void gotoMarket(Context context, String pck) {
        if (!isHaveMarket(context)) {
            QFApplication.showToast("你手机中没有安装应用市场！");
            return;
        }
        Intent intent = new Intent();
        intent.setAction(Intent.ACTION_VIEW);
    ...
    public static PackageInfo getPackageInfo(String pckName) {
        try {
            return QFApplication.context().getPackageManager()
                    .getPackageInfo(pckName, 0);
        } catch (NameNotFoundException e) {
            LogUtil.e(e.getMessage());
        }
    ...
    public static int getVersionCode() {
        int versionCode = 0;
        try {
            versionCode = QFApplication
                    .context()
                    .getPackageManager()
                    .getPackageInfo(QFApplication.context().getPackageName(),
                            0).versionCode;
    ...
    public static int getVersionCode(String packageName) {
        int versionCode = 0;
        try {
            versionCode = QFApplication.context().getPackageManager()
    ...
    public static boolean isScreenOn() {
        PowerManager pm = (PowerManager) QFApplication.context()
    ...
    public static String getIMEI() {
        TelephonyManager tel = (TelephonyManager) QFApplication.context()
    ...
    public static void openApp(Context context, String packageName) {
        Intent mainIntent = QFApplication.context().getPackageManager()
    ...
    public static boolean isWifiOpen() {
        ...
        ConnectivityManager cm = (ConnectivityManager) QFApplication
    ...
    public static int getStatuBarHeight() {
        ...
        try {
            ...
            field = c.getField("status_bar_height");
            x = Integer.parseInt(field.get(obj).toString());
            sbar = QFApplication.context().getResources()
                    .getDimensionPixelSize(x);
    ...
    public static int getNetworkType() {
        int netType = 0;
        ConnectivityManager connectivityManager = (ConnectivityManager) QFApplication
